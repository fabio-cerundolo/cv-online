...
import { User, Phone, Mail, MapPin, Calendar, Book, Award, Briefcase, Code, Server, Package } from 'lucide-react';
        ...
        <section className="mt-8">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start">
              <Award className="w-6 h-6 mr-2 text-yellow-400" />
              <div>
                <h3 className="font-semibold text-purple-700">Attestato Social Marketing e uso integrato dell'AI</h3>
                <p className="text-gray-600">Assocam Camerana</p>
